      ...
      <div className="flex sm:flex-row flex-col mx-auto my-7 relative align-middle">
        ...
        <div className="h-max -z-20">
          ...
          <ul>
            ...
            <li className="list-disc text-start">I make music!(Here's my <a href="https://soundcloud.com/user-550415450">soundcloud</a> if you want to check it out)</li>
            <li className="list-disc text-start">I've been coding for about 7 years now, and I'm not stopping any time soon.</li>
          </ul>
