    ...
    <div className="project-container mx-[1em] my-4">
      ...
      <div className="h-max">
        <a href={props.project.href} target="_blank" className="proj-link">
          <img src={props.project.imgSrc} className="project-pic object-contain w-full h-3/4 rounded-[10px]" loading="lazy" alt="Project Image" />
        </a>
        <p className="subtext">
          <strong>
      ...
      <>
        <img src={props.project.imgSrc} className="project-pic object-fill w-full h-3/4 rounded-[10px]" loading="lazy" alt="Project Image" />
        <p className="subtext">
          <strong>
