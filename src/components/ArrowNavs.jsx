...
const ArrowNavs = (props) => {
  return (
    <div>
      ...
      <button className="fixed right-[3%] top-1/2 bg-transparent text-custom-300 rounded-full p-0 z-50" onClick={() => props.handleRightMove()}><FaArrowCircleRight className="text-3xl" /></button>
    </div>
  );
};
